            ...
            <section className="px-4 md:px-8 max-w-7xl mx-auto mb-32 relative">
                ...
                <div className="max-w-3xl">
                    ...
                    <p className="text-lg md:text-xl text-gray-400 font-medium leading-relaxed max-w-2xl">
                        Arqam Academy is more than just a learning platform. We are a community-driven ecosystem dedicated to building the next generation of world-class software engineers, designers, and innovators.
                    </p>
                </div>
