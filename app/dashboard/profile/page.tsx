    ...
    return (
        <div className="space-y-8 pb-20 max-w-4xl mx-auto">
            ...
            <motion.div
                ...
                className="glass rounded-[3rem] border border-white/5 overflow-hidden relative"
            >
                ...
                <div className="p-8 md:p-12 relative z-10 flex flex-col md:flex-row gap-8 items-start md:items-center mt-12">
                    <div className="w-32 h-32 rounded-[2rem] bg-gray-900 border-4 border-dark flex items-center justify-center text-4xl font-black text-white shadow-2xl relative shrink-0">
                    ...
                    <div className="flex-1">
                        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                            <div>
                                <h2 className="text-3xl font-black text-white leading-none">{user?.name || 'Student Name'}</h2>
                                <p className="text-primary font-bold uppercase tracking-widest text-xs mt-2">{user?.role || 'Student'}</p>
                            </div>
                            <span className="px-4 py-2 bg-white/5 rounded-xl border border-white/10 text-[10px] font-black uppercase text-gray-400">
                ...
                <div className="p-8 md:p-12 border-t border-white/5 bg-black/20 grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="space-y-6">
                        <h3 className="text-xs font-black text-gray-500 uppercase tracking-widest">Personal Information</h3>

                        <div className="space-y-4">
                            <div className="flex items-center gap-4 bg-white/5 p-4 rounded-2xl border border-white/5">
                                <div className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center text-gray-400 shrink-0"><FiUser /></div>
                                <div>
                                    <p className="text-[10px] font-bold text-gray-500 uppercase">Full Name</p>
                                    <p className="text-sm font-black text-white">{user?.name || 'Not provided'}</p>
                                </div>
                            </div>

                            <div className="flex items-center gap-4 bg-white/5 p-4 rounded-2xl border border-white/5">
                                <div className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center text-gray-400 shrink-0"><FiMail /></div>
                                <div>
                                    <p className="text-[10px] font-bold text-gray-500 uppercase">Email Address</p>
                                    <p className="text-sm font-black text-white">{user?.email || 'Not provided'}</p>
                                </div>
                            </div>

                            <div className="flex items-center gap-4 bg-white/5 p-4 rounded-2xl border border-white/5">
                                <div className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center text-gray-400 shrink-0"><FiPhone /></div>
                                <div>
                                    <p className="text-[10px] font-bold text-gray-500 uppercase">Phone Number</p>
                                    <p className="text-sm font-black text-white">{user?.phone || 'Not provided'}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6">
                        <h3 className="text-xs font-black text-gray-500 uppercase tracking-widest">Learning Preferences</h3>

                        <div className="space-y-4">
                            <div className="flex items-center gap-4 bg-white/5 p-4 rounded-2xl border border-white/5">
                                <div className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center text-primary shrink-0"><FiTarget /></div>
                                <div>
                            ...
                            <div className="p-6 bg-primary/10 rounded-2xl border border-primary/20">
                                <h4 className="text-xs font-black text-white uppercase tracking-widest mb-2">Change Password</h4>
                                <p className="text-xs text-gray-400 font-bold mb-4 leading-relaxed">Ensure your account is using a long, random password to stay secure.</p>
