        ...
        <div className="space-y-8">
            <div className="flex flex-col md:flex-row justify-between md:items-end gap-4">
                <div>
                    ...
                    <p className="text-gray-400 font-medium mt-1 text-sm max-w-xl">
                ...
                <div className="flex items-center gap-3 bg-primary/10 border border-primary/20 px-4 py-3 rounded-xl">
                    ...
                    <div>
                        ...
                        <p className="text-lg font-black text-white leading-tight">#42</p>
                    </div>
                </div>
            </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8 mt-4">
                            ...
                            {leaderboard[1] && (
                                <motion.div
                                    ...
                                    className="order-2 md:order-1 glass rounded-3xl p-6 border-2 border-gray-300/20 text-center flex flex-col items-center relative overflow-hidden md:mt-12"
                                >
                                    <div className="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-transparent via-gray-300 to-transparent opacity-50" />
                                    <div className="w-16 h-16 rounded-full bg-gray-300/10 border-2 border-gray-300/30 flex items-center justify-center mb-4">
                                        <span className="text-2xl font-black text-gray-300">#2</span>
                                    </div>
                                    <h3 className="text-lg font-black text-white truncate w-full">{leaderboard[1].name}</h3>
                                    <p className="text-gray-400 font-bold text-xs mt-1">Lvl {leaderboard[1].level || 1}</p>
                                    <div className="mt-4 px-4 py-2 bg-white/5 rounded-xl border border-white/5 w-full">
                                        <span className="text-xl font-black text-white">{leaderboard[1].points}</span> <span className="text-xs text-gray-500 font-bold uppercase">pts</span>
                                    </div>
                                </motion.div>
                            )}
                            ...
                            {leaderboard[0] && (
                                ...
                                >
                                    ...
                                    <h3 className="text-2xl font-black text-white truncate w-full">{leaderboard[0].name}</h3>
                                    <p className="text-yellow-500/80 font-bold text-sm mt-1 uppercase tracking-widest">Master Lvl {leaderboard[0].level || 1}</p>
                                    <div className="mt-6 px-6 py-3 bg-yellow-400/10 rounded-xl border border-yellow-400/20 w-full">
                                        <span className="text-3xl font-black text-yellow-400">{leaderboard[0].points}</span> <span className="text-sm text-yellow-500/50 font-bold uppercase tracking-widest">pts</span>
                                    </div>
                                </motion.div>
                            )}
                            ...
                            {leaderboard[2] && (
                                ...
                                >
                                    ...
                                    <h3 className="text-lg font-black text-white truncate w-full">{leaderboard[2].name}</h3>
                                    <p className="text-gray-400 font-bold text-xs mt-1">Lvl {leaderboard[2].level || 1}</p>
                                    <div className="mt-4 px-4 py-2 bg-white/5 rounded-xl border border-white/5 w-full">
                                        <span className="text-xl font-black text-white">{leaderboard[2].points}</span> <span className="text-xs text-gray-500 font-bold uppercase">pts</span>
                                    </div>
                                </motion.div>
                            )}
                        </div>
                            ...
                            return (
                                ...
                                >
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <div className="flex items-center gap-2 mt-1">
                                                ...
                                                {student.targetGoal && (
                                                    <span className="text-[10px] uppercase font-black tracking-widest text-gray-500 flex items-center gap-1">
                                    ...
                                    <div className="text-right">
                                        <span className="text-xl font-black text-white block leading-none">{student.points}</span>
