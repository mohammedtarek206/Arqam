...
const translations: Record<Language, Record<string, string>> = {
    en: {
        ...
        study_year_label: 'Academic Year',
    ...
    ar: {
        ...
        contact: 'تواصل معنا',
        about: 'عن الأكاديمية',
        training_courses: 'الكورسات الاوفلاين',
        jobs: 'الوظائف',
        apply_now: 'قدّم الآن',
        register_now: 'سجل الآن',
        book_your_seat: 'احجز مكانك',
        field_programming: 'برمجة',
        field_graphic: 'جرافيك',
        field_languages: 'لغات',
        field_networks: 'شبكات',
        field_ai: 'ذكاء اصطناعي',
        field_business: 'Business',
        governorate_label: 'المحافظة',
        college_label: 'الكلية',
        study_year_label: 'السنة الدراسية',
        notes_label: 'ملاحظات (اختياري)',
        login: 'دخول',
        logout: 'خروج',
        dashboard: 'لوحة التحكم',
        admin_panel: 'لوحة الإدارة',
        courses: 'الكورسات الاونلاين',
        pricing: 'الباقات',
