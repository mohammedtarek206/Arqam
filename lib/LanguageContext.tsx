...
const translations: Record<Language, Record<string, string>> = {
    en: {
        ...
        reviews_1_text: 'Arqam Academy changed my career path completely. The practical projects were the key.',
        ...
        about_title: 'About Arqam Academy',
        about_subtitle: 'Building the Future of Tech Education',
        about_desc_1: 'Arqam Academy is a leading platform dedicated to empowering youth through specialized training in programming, cybersecurity, and artificial intelligence.',
        ...
        features_title: 'Why Choose Arqam?',
    ...
    ar: {
        ...
        reviews_1_text: 'أكاديمية أرقام غيرت مسار حياتي المهنية تماماً. المشاريع العملية كانت المفتاح.',
        ...
        about_title: 'عن أكاديمية أرقام',
        about_subtitle: 'نبني مستقبل التعليم التقني',
        about_desc_1: 'أكاديمية أرقام هي منصة رائدة تهدف إلى تمكين الشباب من خلال تدريب متخصص في البرمجة، الأمن السيبراني، والذكاء الاصطناعي.',
        about_desc_2: 'نحن نقدم تجربة تعلم قائمة على المشاريع العملية تسد الفجوة بين المعرفة النظرية ومتطلبات سوق العمل.',
        features_title: 'لماذا تختار أرقام؟',
...
export function LanguageProvider({ children }: { children: React.ReactNode }) {
    const [lang, setLangState] = useState<Language>('ar'); // Default to Arabic for Arqam
